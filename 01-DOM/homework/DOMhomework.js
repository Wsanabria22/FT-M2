...
span.innerHTML = span.innerHTML + ' William Sanabria';
...
function buildToDo(todo, index) {
  ...
  if (todo.complete) toDoCheck.checked = true;
...
function displayToDos() {
  ...
  arrayToDos = buildToDos(toDoItems);
...
function addToDo() {
  ...
  let descToDo = toDoImput.value;
  if (descToDo) {
    let newTodo = new ToDo(descToDo);
